...
const trasacoesRoutes = require('./routes/transacoes');
...
app.use('/projetofinal/transactions', transacoesRoutes);// Configura o servidor para usar as rotas de transações
